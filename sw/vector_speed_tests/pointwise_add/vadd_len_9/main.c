...
int main(void)
{
 ...
 int32_t* result_array =  (int32_t*) malloc(size * sizeof(int32_t));
  ...
  asm volatile(".insn u 0b1011011, %2, 0b11000000001100000111\n\t"
              ".insn i 0b1111011, 0b010,x14, %0,  0b000000000100\n\t"
              ".insn i 0b1111011, 0b010,x23, %1,  0b000000000100\n\t"
              ".insn r 0b1011011, 0b010, 0x00, x23, x14, x23\n\t"   
              ".insn s 0b0101011, 0b010, x23, 0x000(%3)\n\t"         
  :
  :"r"(array), "r"(test_array), "r"(vl), "r"(result_array)
  : "x14","x15","x16","x17","x18","x19","x20","x21","x22","x23","x24","x25","x26","x27","x28","x29","x30", "x31","memory" );
