...
int main(void)
{
 ...
 asm volatile(".insn u 0b1011011, %2, 0b11000000001100000111\n\t"
              ".insn i 0b1111011, 0b010,x10, %0,  0b000000000100\n\t"
              ".insn i 0b1111011, 0b010,x21, %1,  0b000000000100\n\t"
              ".insn r 0b1011011, 0b010, 0x00, x21, x10, x21\n\t"   
              ".insn s 0b0101011, 0b010, x21, 0x000(%3)\n\t"         
  :
  :"r"(array), "r"(test_array), "r"(vl), "r"(result_array)
  : "x10","x11","12","x13","x14","x15","x16","x17","x18","x19","x20","x21","x22","x23","x24","x25","x26","x27","x28","x29","x30", "x31","memory" );
