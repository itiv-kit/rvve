...
int32_t output_val = 0;
  ...
  //input into function is 32-bit signed fixed point with fraction length of 9
  // output is 8-bit signed fixed point number with fraction length of 7 zero point shift of 128 and scaling factor of (1/256)
